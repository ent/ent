...
id: schema-fields
title: Fields
description: "Ent fields, types, IDs, custom Go/database types, scanners, defaults, validators, optionality, and metadata."
---
...
See the [related FAQ](faq#how-to-use-a-custom-generator-of-ids) for more information.
...
use [external templates](code-gen#external-templates). For example:
