...
- `string`
  - `MinLen(i)`
  - `MaxLen(i)`
  - `MinRuneLen(i)` - Validate that the rune(Unicode code point) count of the given value is >= i.
  - `MaxRuneLen(i)` - Validate that the rune(Unicode code point) count of the given value is <= i.
  - `Match(regexp.Regexp)`
  - `NotEmpty`
