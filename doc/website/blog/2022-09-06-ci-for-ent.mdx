...
To support the community with this effort we added to the docs [a guide](/docs/ci) which
...
I will share insights into things we are working on and would like to
...
with internally. If you would like to see these part of Ent or have other ideas
