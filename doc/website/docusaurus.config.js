  ...
  plugins: [
    [
      "docusaurus-plugin-llms",
      {
        ...
        includeBlog: false, // Avoid context bloat for now, but may want to revisit.
        excludeImports: true,
        docsDir: "../md",
      },
    ],
    ...
    footer: {
      links: [
        ...
        },
        {
          title: "LLM Resources",
          items: [
            { label: "llms.txt", href: "https://entgo.io/llms.txt" },
            { label: "llms-full.txt", href: "https://entgo.io/llms-full.txt" },
          ],
        },
        {
          title: "Social",
