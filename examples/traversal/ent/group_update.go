...
func (m *GroupUpdate) SetAdminID(id int) *GroupUpdate {
	m.mutation.SetAdminID(id)
	return m
}

// SetNillableAdminID sets the "admin" edge to the User entity by ID if the given value is not nil.
func (m *GroupUpdate) SetNillableAdminID(id *int) *GroupUpdate {
	if id != nil {
		m = m.SetAdminID(*id)
	}
	return m
...
func (m *GroupUpdate) SetAdmin(v *User) *GroupUpdate {
	return m.SetAdminID(v.ID)
}
...
func (u *GroupUpdate) ClearAdmin() *GroupUpdate {
	u.mutation.ClearAdmin()
	return u
}
...
func (u *GroupUpdate) sqlSave(ctx context.Context) (_n int, err error) {
	...
	if nodes := u.mutation.AdminIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   group.AdminTable,
...
// SetAdminID sets the "admin" edge to the User entity by ID.
func (m *GroupUpdateOne) SetAdminID(id int) *GroupUpdateOne {
	m.mutation.SetAdminID(id)
	return m
}

// SetNillableAdminID sets the "admin" edge to the User entity by ID if the given value is not nil.
func (m *GroupUpdateOne) SetNillableAdminID(id *int) *GroupUpdateOne {
	if id != nil {
		m = m.SetAdminID(*id)
	}
	return m
...
// SetAdmin sets the "admin" edge to the User entity.
func (m *GroupUpdateOne) SetAdmin(v *User) *GroupUpdateOne {
	return m.SetAdminID(v.ID)
}
...
// ClearAdmin clears the "admin" edge to the User entity.
func (u *GroupUpdateOne) ClearAdmin() *GroupUpdateOne {
	u.mutation.ClearAdmin()
	return u
}
