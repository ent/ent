	...
	for i := range columns {
		...
		case user.FieldFoods:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &m.Foods); err != nil {
...
func (m *User) QueryTenant() *TenantQuery {
	return NewUserClient(m.config).QueryTenant(m)
}
...
func (m *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", m.Foods))
	builder.WriteByte(')')
