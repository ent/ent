...
func (m *UserUpdate) SetPublicInfo(v string) *UserUpdate {
	m.mutation.SetPublicInfo(v)
	return m
}

// SetNillablePublicInfo sets the "public_info" field if the given value is not nil.
func (m *UserUpdate) SetNillablePublicInfo(v *string) *UserUpdate {
	if v != nil {
		m.SetPublicInfo(*v)
	}
	return m
...
func (m *UserUpdate) SetPrivateInfo(v string) *UserUpdate {
	m.mutation.SetPrivateInfo(v)
	return m
}

// SetNillablePrivateInfo sets the "private_info" field if the given value is not nil.
func (m *UserUpdate) SetNillablePrivateInfo(v *string) *UserUpdate {
	if v != nil {
		m.SetPrivateInfo(*v)
	}
	return m
...
func (u *UserUpdate) sqlSave(ctx context.Context) (_n int, err error) {
	...
	if value, ok := u.mutation.PublicInfo(); ok {
		_spec.SetField(user.FieldPublicInfo, field.TypeString, value)
	}
	if value, ok := u.mutation.PrivateInfo(); ok {
...
// SetPublicInfo sets the "public_info" field.
func (m *UserUpdateOne) SetPublicInfo(v string) *UserUpdateOne {
	m.mutation.SetPublicInfo(v)
	return m
}

// SetNillablePublicInfo sets the "public_info" field if the given value is not nil.
func (m *UserUpdateOne) SetNillablePublicInfo(v *string) *UserUpdateOne {
	if v != nil {
		m.SetPublicInfo(*v)
	}
	return m
...
// SetPrivateInfo sets the "private_info" field.
func (m *UserUpdateOne) SetPrivateInfo(v string) *UserUpdateOne {
	m.mutation.SetPrivateInfo(v)
	return m
}

// SetNillablePrivateInfo sets the "private_info" field if the given value is not nil.
func (m *UserUpdateOne) SetNillablePrivateInfo(v *string) *UserUpdateOne {
	if v != nil {
		m.SetPrivateInfo(*v)
	}
	return m
