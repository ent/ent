...
type User struct {
	...
	Custom hstore.Hstore `json:"custom,omitempty"`
}
...
func (u *User) assignValues(values ...interface{}) error {
	...
	if value, ok := values[2].(*hstore.Hstore); !ok {
		return fmt.Errorf("unexpected type %T for field custom", values[2])
	} else if value != nil {
		u.Custom = *value
	}
	return nil
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.Custom))
	builder.WriteByte(')')
