...
func (q *SessionQuery) QueryDevice() *SessionDeviceQuery {
	query := (&SessionDeviceClient{config: q.config}).Query()
...
func (q *SessionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (q *SessionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (q *SessionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (q *SessionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
	id, err := q.OnlyID(ctx)
	if err != nil {
		panic(err)
	}
...
func (q *SessionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (q *SessionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (q *SessionQuery) WithDevice(opts ...func(*SessionDeviceQuery)) *SessionQuery {
	query := (&SessionDeviceClient{config: q.config}).Query()
...
func (q *SessionQuery) loadDevice(ctx context.Context, query *SessionDeviceQuery, nodes []*Session, init func(*Session), assign func(*Session, *SessionDevice)) error {
