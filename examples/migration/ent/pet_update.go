...
func (m *PetUpdate) SetWeight(v float64) *PetUpdate {
...
func (m *PetUpdate) SetNillableWeight(v *float64) *PetUpdate {
	if v != nil {
		m.SetWeight(*v)
	}
	return m
...
func (u *PetUpdate) check() error {
	if u.mutation.BestFriendCleared() && len(u.mutation.BestFriendIDs()) > 0 {
...
// SetWeight sets the "weight" field.
func (m *PetUpdateOne) SetWeight(v float64) *PetUpdateOne {
	m.mutation.ResetWeight()
	m.mutation.SetWeight(v)
	return m
}
...
// SetNillableWeight sets the "weight" field if the given value is not nil.
func (m *PetUpdateOne) SetNillableWeight(v *float64) *PetUpdateOne {
	if v != nil {
		m.SetWeight(*v)
	}
	return m
...
// AddWeight adds value to the "weight" field.
func (m *PetUpdateOne) AddWeight(v float64) *PetUpdateOne {
	m.mutation.AddWeight(v)
	return m
}

// SetBestFriendID sets the "best_friend_id" field.
func (m *PetUpdateOne) SetBestFriendID(v uuid.UUID) *PetUpdateOne {
	m.mutation.SetBestFriendID(v)
	return m
}

// SetNillableBestFriendID sets the "best_friend_id" field if the given value is not nil.
func (m *PetUpdateOne) SetNillableBestFriendID(v *uuid.UUID) *PetUpdateOne {
	if v != nil {
		m.SetBestFriendID(*v)
	}
	return m
