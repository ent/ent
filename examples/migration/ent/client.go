...
func (c *CardClient) QueryPayments(m *Card) *PaymentQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *PaymentClient) UpdateOne(m *Payment) *PaymentUpdateOne {
	mutation := newPaymentMutation(c.config, OpUpdateOne, withPayment(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *PaymentClient) DeleteOne(m *Payment) *PaymentDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *PaymentClient) QueryCard(m *Payment) *CardQuery {
...
func (c *SessionClient) QueryDevice(m *Session) *SessionDeviceQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *SessionDeviceClient) UpdateOne(m *SessionDevice) *SessionDeviceUpdateOne {
	mutation := newSessionDeviceMutation(c.config, OpUpdateOne, withSessionDevice(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *SessionDeviceClient) DeleteOne(m *SessionDevice) *SessionDeviceDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *SessionDeviceClient) QuerySessions(m *SessionDevice) *SessionQuery {
...
func (c *UserClient) QueryCards(m *User) *CardQuery {
	query := (&CardClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
