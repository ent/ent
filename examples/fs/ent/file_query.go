...
func (q *FileQuery) QueryParent() *FileQuery {
...
func (q *FileQuery) QueryChildren() *FileQuery {
	query := (&FileClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (q *FileQuery) WithParent(opts ...func(*FileQuery)) *FileQuery {
	query := (&FileClient{config: q.config}).Query()
...
func (q *FileQuery) WithChildren(opts ...func(*FileQuery)) *FileQuery {
	query := (&FileClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *FileQuery) loadParent(ctx context.Context, query *FileQuery, nodes []*File, init func(*File), assign func(*File, *File)) error {
...
func (q *FileQuery) loadChildren(ctx context.Context, query *FileQuery, nodes []*File, init func(*File), assign func(*File, *File)) error {
