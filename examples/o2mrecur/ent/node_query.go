...
func (q *NodeQuery) QueryParent() *NodeQuery {
...
func (q *NodeQuery) QueryChildren() *NodeQuery {
	query := (&NodeClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (q *NodeQuery) WithParent(opts ...func(*NodeQuery)) *NodeQuery {
	query := (&NodeClient{config: q.config}).Query()
...
func (q *NodeQuery) WithChildren(opts ...func(*NodeQuery)) *NodeQuery {
	query := (&NodeClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *NodeQuery) loadParent(ctx context.Context, query *NodeQuery, nodes []*Node, init func(*Node), assign func(*Node, *Node)) error {
...
func (q *NodeQuery) loadChildren(ctx context.Context, query *NodeQuery, nodes []*Node, init func(*Node), assign func(*Node, *Node)) error {
