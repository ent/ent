...
// Real for the PetQuery builder.
func (pq *PetQuery) Real() *PetQuery {
	pq.softdelete = true
	return pq
}
...
func (pq *PetQuery) prepareQuery(ctx context.Context) error {
	...
	if !pq.softdelete {
		pq.predicates = append(pq.predicates, pet.DeletedAtIsNil())
	}
	return nil
}
