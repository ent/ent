...
// Real for the GroupQuery builder.
func (gq *GroupQuery) Real() *GroupQuery {
	gq.softdelete = true
	return gq
}
...
func (gq *GroupQuery) prepareQuery(ctx context.Context) error {
	...
	if !gq.softdelete {
		gq.predicates = append(gq.predicates, group.DeletedAtIsNil())
	}
	return nil
}
