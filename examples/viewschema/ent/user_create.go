...
func (uc *UserCreate) SetPublicInfo(s string) *UserCreate {
	uc.mutation.SetPublicInfo(s)
	return uc
}

// SetPrivateInfo sets the "private_info" field.
func (uc *UserCreate) SetPrivateInfo(s string) *UserCreate {
	uc.mutation.SetPrivateInfo(s)
	return uc
}
