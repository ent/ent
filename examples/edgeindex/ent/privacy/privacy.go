...
// The CityReadRuleFunc type is an adapter to allow the use of ordinary
// functions as a read rule.
type CityReadRuleFunc func(context.Context, *ent.City) error

// EvalRead calls f(ctx, v).
func (f CityReadRuleFunc) EvalRead(ctx context.Context, v ent.Value) error {
	if v, ok := v.(*ent.City); ok {
		return f(ctx, v)
	}
	return Denyf("ent/privacy: unexpected value type %T, expect *ent.City", v)
}

// The CityWriteRuleFunc type is an adapter to allow the use of ordinary
// functions as a write rule.
type CityWriteRuleFunc func(context.Context, *ent.CityMutation) error

// EvalWrite calls f(ctx, m).
func (f CityWriteRuleFunc) EvalWrite(ctx context.Context, m ent.Mutation) error {
...
// The StreetReadRuleFunc type is an adapter to allow the use of ordinary
// functions as a read rule.
type StreetReadRuleFunc func(context.Context, *ent.Street) error

// EvalRead calls f(ctx, v).
func (f StreetReadRuleFunc) EvalRead(ctx context.Context, v ent.Value) error {
	if v, ok := v.(*ent.Street); ok {
		return f(ctx, v)
	}
	return Denyf("ent/privacy: unexpected value type %T, expect *ent.Street", v)
}

// The StreetWriteRuleFunc type is an adapter to allow the use of ordinary
// functions as a write rule.
type StreetWriteRuleFunc func(context.Context, *ent.StreetMutation) error

// EvalWrite calls f(ctx, m).
func (f StreetWriteRuleFunc) EvalWrite(ctx context.Context, m ent.Mutation) error {
