...
func (c *CityClient) UpdateOne(m *City) *CityUpdateOne {
	mutation := newCityMutation(c.config, OpUpdateOne, withCity(m))
...
func (c *CityClient) DeleteOne(m *City) *CityDeleteOne {
...
func (c *CityClient) QueryStreets(m *City) *StreetQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *StreetClient) UpdateOne(m *Street) *StreetUpdateOne {
	mutation := newStreetMutation(c.config, OpUpdateOne, withStreet(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *StreetClient) DeleteOne(m *Street) *StreetDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *StreetClient) QueryCity(m *Street) *CityQuery {
