...
func (m *UserUpdate) AddCars(v ...*Car) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (u *UserUpdate) ClearCars() *UserUpdate {
...
func (u *UserUpdate) RemoveCars(v ...*Car) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCars adds the "cars" edges to the Car entity.
func (m *UserUpdateOne) AddCars(v ...*Car) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCars clears all "cars" edges to the Car entity.
func (u *UserUpdateOne) ClearCars() *UserUpdateOne {
	u.mutation.ClearCars()
	return u
}
...
// RemoveCars removes "cars" edges to Car entities.
func (u *UserUpdateOne) RemoveCars(v ...*Car) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
