...
func (q *UserQuery) QueryCars() *CarQuery {
...
func (q *UserQuery) WithCars(opts ...func(*CarQuery)) *UserQuery {
	query := (&CarClient{config: q.config}).Query()
...
func (q *UserQuery) loadCars(ctx context.Context, query *CarQuery, nodes []*User, init func(*User), assign func(*User, *Car)) error {
