...
func (m *UserAuditLogMutation) SetOperationType(s string) {
	m.operation_type = &s
}

// OperationType returns the value of the "operation_type" field in the mutation.
func (m *UserAuditLogMutation) OperationType() (r string, exists bool) {
	v := m.operation_type
	if v == nil {
		return
	}
...
func (m *UserAuditLogMutation) ResetOperationType() {
	m.operation_type = nil
}

// SetOperationTime sets the "operation_time" field.
func (m *UserAuditLogMutation) SetOperationTime(s string) {
	m.operation_time = &s
}

// OperationTime returns the value of the "operation_time" field in the mutation.
func (m *UserAuditLogMutation) OperationTime() (r string, exists bool) {
	v := m.operation_time
	if v == nil {
		return
	}
...
func (m *UserAuditLogMutation) ResetOperationTime() {
	m.operation_time = nil
}

// SetOldValue sets the "old_value" field.
func (m *UserAuditLogMutation) SetOldValue(s string) {
	m.old_value = &s
}

// OldValue returns the value of the "old_value" field in the mutation.
func (m *UserAuditLogMutation) OldValue() (r string, exists bool) {
	v := m.old_value
	if v == nil {
		return
	}
...
func (m *UserAuditLogMutation) SetNewValue(s string) {
	m.new_value = &s
}

// NewValue returns the value of the "new_value" field in the mutation.
func (m *UserAuditLogMutation) NewValue() (r string, exists bool) {
	v := m.new_value
	if v == nil {
		return
	}
...
func (m *UserAuditLogMutation) Where(ps ...predicate.UserAuditLog) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the UserAuditLogMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *UserAuditLogMutation) WhereP(ps ...func(*sql.Selector)) {
...
// Op returns the operation name.
func (m *UserAuditLogMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *UserAuditLogMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (UserAuditLog).
func (m *UserAuditLogMutation) Type() string {
	return m.typ
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *UserAuditLogMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserAuditLogMutation) SetField(name string, value ent.Value) error {
	switch name {
	case userauditlog.FieldOperationType:
		v, ok := value.(string)
		if !ok {
...
// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *UserAuditLogMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UserAuditLogMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserAuditLogMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UserAuditLogMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *UserAuditLogMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UserAuditLogMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *UserAuditLogMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserAuditLogMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *UserAuditLogMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UserAuditLogMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *UserAuditLogMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown UserAuditLog unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UserAuditLogMutation) ResetEdge(name string) error {
