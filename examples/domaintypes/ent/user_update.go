...
func (m *UserUpdate) SetPostalCode(v string) *UserUpdate {
	m.mutation.SetPostalCode(v)
	return m
}

// SetNillablePostalCode sets the "postal_code" field if the given value is not nil.
func (m *UserUpdate) SetNillablePostalCode(v *string) *UserUpdate {
	if v != nil {
		m.SetPostalCode(*v)
	}
	return m
...
func (u *UserUpdate) sqlSave(ctx context.Context) (_n int, err error) {
	...
	if value, ok := u.mutation.PostalCode(); ok {
...
// SetPostalCode sets the "postal_code" field.
func (m *UserUpdateOne) SetPostalCode(v string) *UserUpdateOne {
	m.mutation.SetPostalCode(v)
	return m
}

// SetNillablePostalCode sets the "postal_code" field if the given value is not nil.
func (m *UserUpdateOne) SetNillablePostalCode(v *string) *UserUpdateOne {
	if v != nil {
		m.SetPostalCode(*v)
	}
	return m
