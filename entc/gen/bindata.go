...
func templateMetaTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/meta.tmpl", size: 2340, mode: os.FileMode(420), modTime: time.Unix(1566835376, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
