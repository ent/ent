...
func templatePredicateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/predicate.tmpl", size: 706, mode: os.FileMode(420), modTime: time.Unix(1564012743, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
