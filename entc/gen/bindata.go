...
func templateMigrateMigrateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/migrate/migrate.tmpl", size: 1041, mode: os.FileMode(420), modTime: time.Unix(1565523579, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateMigrateSchemaTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/migrate/schema.tmpl", size: 2708, mode: os.FileMode(420), modTime: time.Unix(1565180603, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
