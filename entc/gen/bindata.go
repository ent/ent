...
func templateClientTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/client.tmpl", size: 4348, mode: os.FileMode(420), modTime: time.Unix(1566996860, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateMigrateSchemaTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/migrate/schema.tmpl", size: 3595, mode: os.FileMode(420), modTime: time.Unix(1566995215, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
