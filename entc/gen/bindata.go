...
func templateDialectGremlinDecodeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/gremlin/decode.tmpl", size: 1924, mode: os.FileMode(420), modTime: time.Unix(1566925536, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateMigrateSchemaTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/migrate/schema.tmpl", size: 3536, mode: os.FileMode(420), modTime: time.Unix(1566238093, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
