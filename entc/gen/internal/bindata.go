...
func templateDialectSqlErrorsTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/errors.tmpl", size: 1189, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
