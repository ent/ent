...
func templateDialectSqlCreateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/create.tmpl", size: 4713, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
