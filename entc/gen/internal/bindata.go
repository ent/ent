...
func templateBaseTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/base.tmpl", size: 4271, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
