...
func templateEntTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/ent.tmpl", size: 5677, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
