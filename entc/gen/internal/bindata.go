...
func templateBuilderMutationTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/mutation.tmpl", size: 20393, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateBuilderSetterTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/setter.tmpl", size: 4071, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
