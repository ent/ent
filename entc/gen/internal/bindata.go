...
func templateBaseTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/base.tmpl", size: 5099, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
...
func templateBuilderQueryTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/query.tmpl", size: 15567, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
