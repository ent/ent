...
func templateDialectSqlUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/update.tmpl", size: 4398, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
