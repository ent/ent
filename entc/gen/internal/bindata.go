...
func templateMetaTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/meta.tmpl", size: 4293, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
