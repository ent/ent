...
func templateEnttestTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/enttest.tmpl", size: 2261, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
