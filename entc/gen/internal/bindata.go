...
func templatePrivacyTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/privacy.tmpl", size: 5608, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
