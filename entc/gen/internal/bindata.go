...
func templateBuilderUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/update.tmpl", size: 8076, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
