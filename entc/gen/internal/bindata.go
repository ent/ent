...
func templateBuilderMutationTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/mutation.tmpl", size: 17122, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
