...
func templateDialectSqlQueryTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/query.tmpl", size: 4429, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
