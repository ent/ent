...
func templateMigrateMigrateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/migrate/migrate.tmpl", size: 2799, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
