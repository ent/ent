...
func templateRuntimeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/runtime.tmpl", size: 7076, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
