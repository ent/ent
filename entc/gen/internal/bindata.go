...
func templateBuilderQueryTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/query.tmpl", size: 17262, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
