...
func templateDialectSqlUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/update.tmpl", size: 12712, mode: os.FileMode(420), modTime: time.Unix(1569251090, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
