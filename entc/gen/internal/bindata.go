...
func templateDialectSqlCreateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/create.tmpl", size: 6409, mode: os.FileMode(420), modTime: time.Unix(1568799191, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateDialectSqlUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dialect/sql/update.tmpl", size: 12590, mode: os.FileMode(420), modTime: time.Unix(1568799587, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
