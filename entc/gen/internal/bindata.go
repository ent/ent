...
func templateBuilderQueryTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/builder/query.tmpl", size: 15832, mode: os.FileMode(420), modTime: time.Unix(1571144548, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
