...
func (q *UserQuery) QueryPosts() *PostQuery {
...
func (q *UserQuery) WithPosts(opts ...func(*PostQuery)) *UserQuery {
	query := (&PostClient{config: q.config}).Query()
...
func (q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := q.withPosts; query != nil {
		if err := q.loadPosts(ctx, query, nodes,
...
func (q *UserQuery) loadPosts(ctx context.Context, query *PostQuery, nodes []*User, init func(*User), assign func(*User, *Post)) error {
