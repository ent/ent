...
type User struct {
	...
	Account *user.User `json:"account,omitempty"`
	// State holds the value of the "state" field.
	State        entuser.State `json:"state,omitempty"`
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case entuser.FieldAccount:
			if value, ok := values[i].(*user.User); !ok {
		...
		case entuser.FieldState:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				u.State = entuser.State(value.String)
			}
		default:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.Account))
	builder.WriteString(", ")
