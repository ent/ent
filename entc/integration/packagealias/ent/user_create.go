...
func (uc *UserCreate) SetAccount(u *user.User) *UserCreate {
	uc.mutation.SetAccount(u)
	return uc
}

// SetState sets the "state" field.
func (uc *UserCreate) SetState(u entuser.State) *UserCreate {
	uc.mutation.SetState(u)
	return uc
}

// SetNillableState sets the "state" field if the given value is not nil.
func (uc *UserCreate) SetNillableState(u *entuser.State) *UserCreate {
	if u != nil {
		uc.SetState(*u)
	}
	return uc
