...
func (uu *UserUpdate) SetAccount(u *user.User) *UserUpdate {
	uu.mutation.SetAccount(u)
	return uu
}

// SetState sets the "state" field.
func (uu *UserUpdate) SetState(u entuser.State) *UserUpdate {
	uu.mutation.SetState(u)
	return uu
}

// SetNillableState sets the "state" field if the given value is not nil.
func (uu *UserUpdate) SetNillableState(u *entuser.State) *UserUpdate {
	if u != nil {
		uu.SetState(*u)
	}
	return uu
...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.State(); ok {
		if err := entuser.StateValidator(v); err != nil {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Account(); ok {
		_spec.SetField(entuser.FieldAccount, field.TypeOther, value)
	}
	if value, ok := uu.mutation.State(); ok {
		_spec.SetField(entuser.FieldState, field.TypeEnum, value)
	}
...
// SetAccount sets the "account" field.
func (uuo *UserUpdateOne) SetAccount(u *user.User) *UserUpdateOne {
	uuo.mutation.SetAccount(u)
	return uuo
}

// SetState sets the "state" field.
func (uuo *UserUpdateOne) SetState(u entuser.State) *UserUpdateOne {
	uuo.mutation.SetState(u)
	return uuo
}

// SetNillableState sets the "state" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableState(u *entuser.State) *UserUpdateOne {
	if u != nil {
		uuo.SetState(*u)
	}
	return uuo
