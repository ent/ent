...
func (m *UserCreate) SetAge(v uint) *UserCreate {
	m.mutation.SetAge(v)
	return m
}

// SetNillableAge sets the "age" field if the given value is not nil.
func (m *UserCreate) SetNillableAge(v *uint) *UserCreate {
	if v != nil {
		m.SetAge(*v)
	}
	return m
...
func (m *UserCreate) AddTeamIDs(ids ...int) *UserCreate {
	m.mutation.AddTeamIDs(ids...)
	return m
}

// AddTeams adds the "teams" edges to the Team entity.
func (m *UserCreate) AddTeams(v ...*Team) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (m *UserCreate) AddTaskIDs(ids ...int) *UserCreate {
	m.mutation.AddTaskIDs(ids...)
	return m
}

// AddTasks adds the "tasks" edges to the Task entity.
func (m *UserCreate) AddTasks(v ...*Task) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
