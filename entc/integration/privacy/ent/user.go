...
func (m *User) QueryTeams() *TeamQuery {
	return NewUserClient(m.config).QueryTeams(m)
}

// QueryTasks queries the "tasks" edge of the User entity.
func (m *User) QueryTasks() *TaskQuery {
	return NewUserClient(m.config).QueryTasks(m)
}
