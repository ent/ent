...
func (m *NoteMutation) SetReadonly(b bool) {
	m.readonly = &b
}

// Readonly returns the value of the "readonly" field in the mutation.
func (m *NoteMutation) Readonly() (r bool, exists bool) {
	v := m.readonly
	if v == nil {
		return
	}
...
// OldReadonly returns the old "readonly" field's value of the Note entity.
// If the Note object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NoteMutation) OldReadonly(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NoteMutation) ResetReadonly() {
	m.readonly = nil
}
...
func (m *NoteMutation) Fields() []string {
	...
	if m.readonly != nil {
		fields = append(fields, note.FieldReadonly)
	}
	return fields
}
