...
func (c *TaskClient) QueryTeams(m *Task) *TeamQuery {
...
func (c *TaskClient) QueryOwner(m *Task) *UserQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *TeamClient) UpdateOne(m *Team) *TeamUpdateOne {
	mutation := newTeamMutation(c.config, OpUpdateOne, withTeam(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TeamClient) DeleteOne(m *Team) *TeamDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *TeamClient) QueryTasks(m *Team) *TaskQuery {
...
func (c *TeamClient) QueryUsers(m *Team) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryTeams(m *User) *TeamQuery {
	query := (&TeamClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryTasks(m *User) *TaskQuery {
	query := (&TaskClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
