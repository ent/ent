...
func (q *UserQuery) QueryTeams() *TeamQuery {
...
func (q *UserQuery) QueryTasks() *TaskQuery {
...
func (q *UserQuery) WithTeams(opts ...func(*TeamQuery)) *UserQuery {
	query := (&TeamClient{config: q.config}).Query()
...
func (q *UserQuery) WithTasks(opts ...func(*TaskQuery)) *UserQuery {
	query := (&TaskClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) loadTeams(ctx context.Context, query *TeamQuery, nodes []*User, init func(*User), assign func(*User, *Team)) error {
...
func (q *UserQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*User, init func(*User), assign func(*User, *Task)) error {
