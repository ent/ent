...
func Int64ToString(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Int64ToStringEQ(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldInt64ToString), v))
	})
}
...
func Int64ToStringNEQ(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Int64ToStringIn(vs ...int64) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func Int64ToStringNotIn(vs ...int64) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func Int64ToStringGT(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Int64ToStringGTE(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Int64ToStringLT(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Int64ToStringLTE(v int64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
