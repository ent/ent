...
func (m *CustomTypeCreate) SetTz0(v time.Time) *CustomTypeCreate {
	m.mutation.SetTz0(v)
	return m
}

// SetNillableTz0 sets the "tz0" field if the given value is not nil.
func (m *CustomTypeCreate) SetNillableTz0(v *time.Time) *CustomTypeCreate {
	if v != nil {
		m.SetTz0(*v)
	}
	return m
...
func (m *CustomTypeCreate) SetTz3(v time.Time) *CustomTypeCreate {
	m.mutation.SetTz3(v)
	return m
}

// SetNillableTz3 sets the "tz3" field if the given value is not nil.
func (m *CustomTypeCreate) SetNillableTz3(v *time.Time) *CustomTypeCreate {
	if v != nil {
		m.SetTz3(*v)
	}
	return m
...
func (c *CustomTypeCreate) createSpec() (*CustomType, *sqlgraph.CreateSpec) {
	...
	if value, ok := c.mutation.Tz0(); ok {
		_spec.SetField(customtype.FieldTz0, field.TypeTime, value)
		_node.Tz0 = value
	}
	if value, ok := c.mutation.Tz3(); ok {
