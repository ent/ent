...
func (u *ZooUpdate) Where(ps ...predicate.Zoo) *ZooUpdate {
	u.mutation.Where(ps...)
	return u
}

// Mutation returns the ZooMutation object of the builder.
func (m *ZooUpdate) Mutation() *ZooMutation {
	return m.mutation
}

// Save executes the query and returns the number of nodes affected by the update operation.
func (u *ZooUpdate) Save(ctx context.Context) (int, error) {
	return withHooks(ctx, u.sqlSave, u.mutation, u.hooks)
}

// SaveX is like Save, but panics if an error occurs.
func (u *ZooUpdate) SaveX(ctx context.Context) int {
...
func (u *ZooUpdate) Exec(ctx context.Context) error {
	_, err := u.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (u *ZooUpdate) ExecX(ctx context.Context) {
	if err := u.Exec(ctx); err != nil {
		panic(err)
	}
}

func (u *ZooUpdate) sqlSave(ctx context.Context) (_n int, err error) {
...
// Mutation returns the ZooMutation object of the builder.
func (m *ZooUpdateOne) Mutation() *ZooMutation {
	return m.mutation
}

// Where appends a list predicates to the ZooUpdate builder.
func (u *ZooUpdateOne) Where(ps ...predicate.Zoo) *ZooUpdateOne {
	u.mutation.Where(ps...)
	return u
}
...
func (u *ZooUpdateOne) Select(field string, fields ...string) *ZooUpdateOne {
	u.fields = append([]string{field}, fields...)
	return u
}

// Save executes the query and returns the updated Zoo entity.
func (u *ZooUpdateOne) Save(ctx context.Context) (*Zoo, error) {
	return withHooks(ctx, u.sqlSave, u.mutation, u.hooks)
}

// SaveX is like Save, but panics if an error occurs.
func (u *ZooUpdateOne) SaveX(ctx context.Context) *Zoo {
	node, err := u.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (u *ZooUpdateOne) Exec(ctx context.Context) error {
	_, err := u.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (u *ZooUpdateOne) ExecX(ctx context.Context) {
	if err := u.Exec(ctx); err != nil {
		panic(err)
	}
}

func (u *ZooUpdateOne) sqlSave(ctx context.Context) (_n *Zoo, err error) {
	_spec := sqlgraph.NewUpdateSpec(zoo.Table, zoo.Columns, sqlgraph.NewFieldSpec(zoo.FieldID, field.TypeInt))
	id, ok := u.mutation.ID()
	if !ok {
