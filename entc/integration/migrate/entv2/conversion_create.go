...
func (m *ConversionCreate) SetInt8ToString(v string) *ConversionCreate {
	m.mutation.SetInt8ToString(v)
	return m
}

// SetNillableInt8ToString sets the "int8_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableInt8ToString(v *string) *ConversionCreate {
	if v != nil {
		m.SetInt8ToString(*v)
	}
	return m
...
func (m *ConversionCreate) SetUint8ToString(v string) *ConversionCreate {
	m.mutation.SetUint8ToString(v)
	return m
}

// SetNillableUint8ToString sets the "uint8_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableUint8ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetInt16ToString(v string) *ConversionCreate {
	m.mutation.SetInt16ToString(v)
	return m
}

// SetNillableInt16ToString sets the "int16_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableInt16ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetUint16ToString(v string) *ConversionCreate {
	m.mutation.SetUint16ToString(v)
	return m
}

// SetNillableUint16ToString sets the "uint16_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableUint16ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetInt32ToString(v string) *ConversionCreate {
	m.mutation.SetInt32ToString(v)
	return m
}

// SetNillableInt32ToString sets the "int32_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableInt32ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetUint32ToString(v string) *ConversionCreate {
	m.mutation.SetUint32ToString(v)
	return m
}

// SetNillableUint32ToString sets the "uint32_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableUint32ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetInt64ToString(v string) *ConversionCreate {
	m.mutation.SetInt64ToString(v)
	return m
}

// SetNillableInt64ToString sets the "int64_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableInt64ToString(v *string) *ConversionCreate {
	if v != nil {
...
func (m *ConversionCreate) SetUint64ToString(v string) *ConversionCreate {
	m.mutation.SetUint64ToString(v)
	return m
}

// SetNillableUint64ToString sets the "uint64_to_string" field if the given value is not nil.
func (m *ConversionCreate) SetNillableUint64ToString(v *string) *ConversionCreate {
	if v != nil {
