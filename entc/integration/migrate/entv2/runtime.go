...
func init() {
	...
	userDescBuffer := userFields[8].Descriptor()
	...
	userDescTitle := userFields[9].Descriptor()
	...
	userDescNewToken := userFields[11].Descriptor()
	...
	userDescBlob := userFields[12].Descriptor()
	...
	userDescDropOptional := userFields[20].Descriptor()
