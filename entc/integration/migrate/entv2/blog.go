...
// to the Blog fields.
func (m *Blog) assignValues(columns []string, values []any) error {
...
func (m *Blog) Value(name string) (ent.Value, error) {
	return m.selectValues.Get(name)
}

// QueryAdmins queries the "admins" edge of the Blog entity.
func (m *Blog) QueryAdmins() *UserQuery {
	return NewBlogClient(m.config).QueryAdmins(m)
}
...
func (m *Blog) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", m.Oid))
	builder.WriteByte(')')
