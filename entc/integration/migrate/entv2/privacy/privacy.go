...
func (c contextDecision) EvalQuery(ctx context.Context, _ entv2.Query) error {
	return c.eval(ctx)
}

func (c contextDecision) EvalMutation(ctx context.Context, _ entv2.Mutation) error {
	return c.eval(ctx)
}
