...
func (d *ProcessDelete) Where(ps ...predicate.Process) *ProcessDelete {
	d.mutation.Where(ps...)
	return d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (d *ProcessDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, d.sqlExec, d.mutation, d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (d *ProcessDelete) ExecX(ctx context.Context) int {
	n, err := d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (d *ProcessDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the ProcessDelete builder.
func (d *ProcessDeleteOne) Where(ps ...predicate.Process) *ProcessDeleteOne {
	d.d.mutation.Where(ps...)
	return d
}

// Exec executes the deletion query.
func (d *ProcessDeleteOne) Exec(ctx context.Context) error {
	n, err := d.d.Exec(ctx)
	switch {
	case err != nil:
		return err
...
// ExecX is like Exec, but panics if an error occurs.
func (d *ProcessDeleteOne) ExecX(ctx context.Context) {
