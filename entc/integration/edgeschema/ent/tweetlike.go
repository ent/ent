...
func (m *TweetLike) assignValues(columns []string, values []any) error {
...
func (m *TweetLike) Value(name string) (ent.Value, error) {
	return m.selectValues.Get(name)
}

// QueryTweet queries the "tweet" edge of the TweetLike entity.
func (m *TweetLike) QueryTweet() *TweetQuery {
	return NewTweetLikeClient(m.config).QueryTweet(m)
}

// QueryUser queries the "user" edge of the TweetLike entity.
func (m *TweetLike) QueryUser() *UserQuery {
	return NewTweetLikeClient(m.config).QueryUser(m)
}
...
func (m *TweetLike) Update() *TweetLikeUpdateOne {
	return NewTweetLikeClient(m.config).UpdateOne(m)
}

// Unwrap unwraps the TweetLike entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (m *TweetLike) Unwrap() *TweetLike {
...
func (m *TweetLike) String() string {
	var builder strings.Builder
	builder.WriteString("TweetLike(")
	builder.WriteString("liked_at=")
	builder.WriteString(m.LikedAt.Format(time.ANSIC))
	builder.WriteString(", ")
