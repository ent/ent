...
func (m *Group) QueryTags() *TagQuery {
	return NewGroupClient(m.config).QueryTags(m)
}

// QueryJoinedUsers queries the "joined_users" edge of the Group entity.
func (m *Group) QueryJoinedUsers() *UserGroupQuery {
	return NewGroupClient(m.config).QueryJoinedUsers(m)
}

// QueryGroupTags queries the "group_tags" edge of the Group entity.
func (m *Group) QueryGroupTags() *GroupTagQuery {
	return NewGroupClient(m.config).QueryGroupTags(m)
}
