...
func (q *UserQuery) QueryRelatives() *UserQuery {
	query := (&UserClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (q *UserQuery) QueryLikedTweets() *TweetQuery {
...
func (q *UserQuery) QueryTweets() *TweetQuery {
	query := (&TweetClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (q *UserQuery) QueryRoles() *RoleQuery {
...
func (q *UserQuery) QueryJoinedGroups() *UserGroupQuery {
	query := (&UserGroupClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (q *UserQuery) QueryFriendships() *FriendshipQuery {
	query := (&FriendshipClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (q *UserQuery) QueryRelationship() *RelationshipQuery {
	query := (&RelationshipClient{config: q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (q *UserQuery) QueryLikes() *TweetLikeQuery {
...
func (q *UserQuery) QueryUserTweets() *UserTweetQuery {
...
func (q *UserQuery) QueryRolesUsers() *RoleUserQuery {
...
func (q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withRelatives:    q.withRelatives.Clone(),
		withLikedTweets:  q.withLikedTweets.Clone(),
		withTweets:       q.withTweets.Clone(),
		withRoles:        q.withRoles.Clone(),
		withJoinedGroups: q.withJoinedGroups.Clone(),
		withFriendships:  q.withFriendships.Clone(),
		withRelationship: q.withRelationship.Clone(),
		withLikes:        q.withLikes.Clone(),
		withUserTweets:   q.withUserTweets.Clone(),
...
func (q *UserQuery) WithRelatives(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	q.withRelatives = query
	return q
}
...
func (q *UserQuery) WithLikedTweets(opts ...func(*TweetQuery)) *UserQuery {
	query := (&TweetClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	q.withLikedTweets = query
	return q
}
...
func (q *UserQuery) WithTweets(opts ...func(*TweetQuery)) *UserQuery {
	query := (&TweetClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) WithRoles(opts ...func(*RoleQuery)) *UserQuery {
	query := (&RoleClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) WithJoinedGroups(opts ...func(*UserGroupQuery)) *UserQuery {
	query := (&UserGroupClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	q.withJoinedGroups = query
	return q
}
...
func (q *UserQuery) WithFriendships(opts ...func(*FriendshipQuery)) *UserQuery {
	query := (&FriendshipClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) WithRelationship(opts ...func(*RelationshipQuery)) *UserQuery {
	query := (&RelationshipClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	q.withRelationship = query
	return q
}
...
func (q *UserQuery) WithLikes(opts ...func(*TweetLikeQuery)) *UserQuery {
	query := (&TweetLikeClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) WithUserTweets(opts ...func(*UserTweetQuery)) *UserQuery {
	query := (&UserTweetClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	q.withUserTweets = query
	return q
}
...
func (q *UserQuery) WithRolesUsers(opts ...func(*RoleUserQuery)) *UserQuery {
	query := (&RoleUserClient{config: q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (q *UserQuery) prepareQuery(ctx context.Context) error {
	...
	if err := user.Policy.EvalQuery(ctx, q); err != nil {
		return err
	}
	return nil
}
...
func (q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [12]bool{
			...
			q.withFriends != nil,
			q.withRelatives != nil,
			q.withLikedTweets != nil,
			q.withTweets != nil,
			q.withRoles != nil,
			q.withJoinedGroups != nil,
			q.withFriendships != nil,
			q.withRelationship != nil,
			q.withLikes != nil,
			q.withUserTweets != nil,
	...
	if query := q.withRelatives; query != nil {
		if err := q.loadRelatives(ctx, query, nodes,
			func(n *User) { n.Edges.Relatives = []*User{} },
			func(n *User, e *User) { n.Edges.Relatives = append(n.Edges.Relatives, e) }); err != nil {
			return nil, err
		}
	}
	if query := q.withLikedTweets; query != nil {
		if err := q.loadLikedTweets(ctx, query, nodes,
	...
	if query := q.withRoles; query != nil {
		if err := q.loadRoles(ctx, query, nodes,
			func(n *User) { n.Edges.Roles = []*Role{} },
			func(n *User, e *Role) { n.Edges.Roles = append(n.Edges.Roles, e) }); err != nil {
			return nil, err
		}
	}
	if query := q.withJoinedGroups; query != nil {
		if err := q.loadJoinedGroups(ctx, query, nodes,
	...
	if query := q.withFriendships; query != nil {
		if err := q.loadFriendships(ctx, query, nodes,
	...
	if query := q.withRelationship; query != nil {
		if err := q.loadRelationship(ctx, query, nodes,
	...
	if query := q.withUserTweets; query != nil {
		if err := q.loadUserTweets(ctx, query, nodes,
...
func (q *UserQuery) loadRelatives(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
...
func (q *UserQuery) loadLikedTweets(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
...
func (q *UserQuery) loadTweets(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
...
func (q *UserQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*User, init func(*User), assign func(*User, *Role)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
...
func (q *UserQuery) loadJoinedGroups(ctx context.Context, query *UserGroupQuery, nodes []*User, init func(*User), assign func(*User, *UserGroup)) error {
...
func (q *UserQuery) loadFriendships(ctx context.Context, query *FriendshipQuery, nodes []*User, init func(*User), assign func(*User, *Friendship)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (q *UserQuery) loadRelationship(ctx context.Context, query *RelationshipQuery, nodes []*User, init func(*User), assign func(*User, *Relationship)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (q *UserQuery) loadLikes(ctx context.Context, query *TweetLikeQuery, nodes []*User, init func(*User), assign func(*User, *TweetLike)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (q *UserQuery) loadUserTweets(ctx context.Context, query *UserTweetQuery, nodes []*User, init func(*User), assign func(*User, *UserTweet)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (q *UserQuery) loadRolesUsers(ctx context.Context, query *RoleUserQuery, nodes []*User, init func(*User), assign func(*User, *RoleUser)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
