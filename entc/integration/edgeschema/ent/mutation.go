...
func (m *AttachedFileMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		...
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, attachedfile.ID(id))
...
func (m *GroupTagMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, grouptag.ID(id))
...
func (m *ProcessMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, process.ID(id))
...
func (m *RelationshipInfoMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, relationshipinfo.ID(id))
...
func (m *RoleMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, role.ID(id))
...
func (m *TagMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, tag.ID(id))
...
func (m *TweetMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, tweet.ID(id))
...
func (m *TweetTagMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, tweettag.ID(id))
...
func (m *UserGroupMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, usergroup.ID(id))
...
func (m *UserTweetMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists && len(m.predicates) > 0 {
			m.predicates = append(m.predicates, usertweet.ID(id))
