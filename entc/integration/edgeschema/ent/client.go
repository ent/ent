...
func (c *AttachedFileClient) UpdateOne(m *AttachedFile) *AttachedFileUpdateOne {
	mutation := newAttachedFileMutation(c.config, OpUpdateOne, withAttachedFile(m))
...
func (c *AttachedFileClient) DeleteOne(m *AttachedFile) *AttachedFileDeleteOne {
...
func (c *AttachedFileClient) QueryFi(m *AttachedFile) *FileQuery {
...
func (c *AttachedFileClient) QueryProc(m *AttachedFile) *ProcessQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *FileClient) UpdateOne(m *File) *FileUpdateOne {
	mutation := newFileMutation(c.config, OpUpdateOne, withFile(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *FileClient) DeleteOne(m *File) *FileDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *FileClient) QueryProcesses(m *File) *ProcessQuery {
	query := (&ProcessClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *FriendshipClient) UpdateOne(m *Friendship) *FriendshipUpdateOne {
	mutation := newFriendshipMutation(c.config, OpUpdateOne, withFriendship(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *FriendshipClient) DeleteOne(m *Friendship) *FriendshipDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *FriendshipClient) QueryUser(m *Friendship) *UserQuery {
...
func (c *FriendshipClient) QueryFriend(m *Friendship) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *GroupClient) QueryTags(m *Group) *TagQuery {
...
func (c *GroupClient) QueryJoinedUsers(m *Group) *UserGroupQuery {
...
func (c *GroupClient) QueryGroupTags(m *Group) *GroupTagQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *GroupTagClient) UpdateOne(m *GroupTag) *GroupTagUpdateOne {
	mutation := newGroupTagMutation(c.config, OpUpdateOne, withGroupTag(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *GroupTagClient) DeleteOne(m *GroupTag) *GroupTagDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *GroupTagClient) QueryTag(m *GroupTag) *TagQuery {
	query := (&TagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *GroupTagClient) QueryGroup(m *GroupTag) *GroupQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *ProcessClient) UpdateOne(m *Process) *ProcessUpdateOne {
	mutation := newProcessMutation(c.config, OpUpdateOne, withProcess(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *ProcessClient) DeleteOne(m *Process) *ProcessDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *ProcessClient) QueryFiles(m *Process) *FileQuery {
	query := (&FileClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *ProcessClient) QueryAttachedFiles(m *Process) *AttachedFileQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *RelationshipClient) UpdateOne(m *Relationship) *RelationshipUpdateOne {
	mutation := newRelationshipMutation(c.config, OpUpdateOne)
	mutation.user = &m.UserID
	mutation.relative = &m.RelativeID
...
func (c *RelationshipClient) QueryUser(m *Relationship) *UserQuery {
	return c.Query().
		Where(relationship.UserID(m.UserID), relationship.RelativeID(m.RelativeID)).
		QueryUser()
}

// QueryRelative queries the relative edge of a Relationship.
func (c *RelationshipClient) QueryRelative(m *Relationship) *UserQuery {
	return c.Query().
		Where(relationship.UserID(m.UserID), relationship.RelativeID(m.RelativeID)).
		QueryRelative()
}
...
func (c *RelationshipClient) QueryInfo(m *Relationship) *RelationshipInfoQuery {
	return c.Query().
		Where(relationship.UserID(m.UserID), relationship.RelativeID(m.RelativeID)).
		QueryInfo()
}
...
// UpdateOne returns an update builder for the given entity.
func (c *RelationshipInfoClient) UpdateOne(m *RelationshipInfo) *RelationshipInfoUpdateOne {
	mutation := newRelationshipInfoMutation(c.config, OpUpdateOne, withRelationshipInfo(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *RelationshipInfoClient) DeleteOne(m *RelationshipInfo) *RelationshipInfoDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *RoleClient) UpdateOne(m *Role) *RoleUpdateOne {
	mutation := newRoleMutation(c.config, OpUpdateOne, withRole(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *RoleClient) DeleteOne(m *Role) *RoleDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *RoleClient) QueryUser(m *Role) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *RoleClient) QueryRolesUsers(m *Role) *RoleUserQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *RoleUserClient) UpdateOne(m *RoleUser) *RoleUserUpdateOne {
	mutation := newRoleUserMutation(c.config, OpUpdateOne)
	mutation.user = &m.UserID
	mutation.role = &m.RoleID
...
func (c *RoleUserClient) QueryRole(m *RoleUser) *RoleQuery {
	return c.Query().
		Where(roleuser.UserID(m.UserID), roleuser.RoleID(m.RoleID)).
		QueryRole()
}

// QueryUser queries the user edge of a RoleUser.
func (c *RoleUserClient) QueryUser(m *RoleUser) *UserQuery {
	return c.Query().
		Where(roleuser.UserID(m.UserID), roleuser.RoleID(m.RoleID)).
		QueryUser()
}
...
// UpdateOne returns an update builder for the given entity.
func (c *TagClient) UpdateOne(m *Tag) *TagUpdateOne {
	mutation := newTagMutation(c.config, OpUpdateOne, withTag(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TagClient) DeleteOne(m *Tag) *TagDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *TagClient) QueryTweets(m *Tag) *TweetQuery {
...
func (c *TagClient) QueryGroups(m *Tag) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *TagClient) QueryTweetTags(m *Tag) *TweetTagQuery {
...
func (c *TagClient) QueryGroupTags(m *Tag) *GroupTagQuery {
	query := (&GroupTagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *TweetClient) UpdateOne(m *Tweet) *TweetUpdateOne {
	mutation := newTweetMutation(c.config, OpUpdateOne, withTweet(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TweetClient) DeleteOne(m *Tweet) *TweetDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *TweetClient) QueryLikedUsers(m *Tweet) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *TweetClient) QueryUser(m *Tweet) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *TweetClient) QueryTags(m *Tweet) *TagQuery {
	query := (&TagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *TweetClient) QueryLikes(m *Tweet) *TweetLikeQuery {
...
func (c *TweetClient) QueryTweetUser(m *Tweet) *UserTweetQuery {
...
func (c *TweetClient) QueryTweetTags(m *Tweet) *TweetTagQuery {
	query := (&TweetTagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *TweetLikeClient) UpdateOne(m *TweetLike) *TweetLikeUpdateOne {
	mutation := newTweetLikeMutation(c.config, OpUpdateOne)
	mutation.user = &m.UserID
	mutation.tweet = &m.TweetID
...
func (c *TweetLikeClient) QueryTweet(m *TweetLike) *TweetQuery {
	return c.Query().
		Where(tweetlike.UserID(m.UserID), tweetlike.TweetID(m.TweetID)).
		QueryTweet()
}

// QueryUser queries the user edge of a TweetLike.
func (c *TweetLikeClient) QueryUser(m *TweetLike) *UserQuery {
	return c.Query().
		Where(tweetlike.UserID(m.UserID), tweetlike.TweetID(m.TweetID)).
		QueryUser()
}
...
// UpdateOne returns an update builder for the given entity.
func (c *TweetTagClient) UpdateOne(m *TweetTag) *TweetTagUpdateOne {
	mutation := newTweetTagMutation(c.config, OpUpdateOne, withTweetTag(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TweetTagClient) DeleteOne(m *TweetTag) *TweetTagDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *TweetTagClient) QueryTag(m *TweetTag) *TagQuery {
	query := (&TagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *TweetTagClient) QueryTweet(m *TweetTag) *TweetQuery {
	query := (&TweetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryRelatives(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryLikedTweets(m *User) *TweetQuery {
	query := (&TweetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryTweets(m *User) *TweetQuery {
	query := (&TweetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryRoles(m *User) *RoleQuery {
...
func (c *UserClient) QueryJoinedGroups(m *User) *UserGroupQuery {
	query := (&UserGroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryFriendships(m *User) *FriendshipQuery {
...
func (c *UserClient) QueryRelationship(m *User) *RelationshipQuery {
...
func (c *UserClient) QueryLikes(m *User) *TweetLikeQuery {
	query := (&TweetLikeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryUserTweets(m *User) *UserTweetQuery {
	query := (&UserTweetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryRolesUsers(m *User) *RoleUserQuery {
	query := (&RoleUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *UserGroupClient) UpdateOne(m *UserGroup) *UserGroupUpdateOne {
	mutation := newUserGroupMutation(c.config, OpUpdateOne, withUserGroup(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *UserGroupClient) DeleteOne(m *UserGroup) *UserGroupDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *UserGroupClient) QueryUser(m *UserGroup) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserGroupClient) QueryGroup(m *UserGroup) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *UserTweetClient) UpdateOne(m *UserTweet) *UserTweetUpdateOne {
	mutation := newUserTweetMutation(c.config, OpUpdateOne, withUserTweet(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *UserTweetClient) DeleteOne(m *UserTweet) *UserTweetDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *UserTweetClient) QueryUser(m *UserTweet) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserTweetClient) QueryTweet(m *UserTweet) *TweetQuery {
	query := (&TweetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
