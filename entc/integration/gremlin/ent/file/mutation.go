...
func (m *Mutation) SetTypeID(id string) {
	m._type = &id
}
...
func (m *Mutation) TypeID() (id string, exists bool) {
	if m._type != nil {
		return *m._type, true
	}
	return
...
func (m *Mutation) TypeIDs() (ids []string) {
...
func (m *Mutation) AddFieldIDs(ids ...string) {
	if m.field == nil {
...
func (m *Mutation) RemoveFieldIDs(ids ...string) {
...
func (m *Mutation) RemovedFieldIDs() (ids []string) {
...
func (m *Mutation) FieldIDs() (ids []string) {
