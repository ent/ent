...
func (m *Mutation) AddSpecIDs(ids ...string) {
	if m.spec == nil {
...
func (m *Mutation) RemoveSpecIDs(ids ...string) {
...
func (m *Mutation) RemovedSpecIDs() (ids []string) {
...
func (m *Mutation) SpecIDs() (ids []string) {
	for id := range m.spec {
		ids = append(ids, id)
	}
	return
