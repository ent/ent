...
func (m *FieldTypeMutation) SetFileID(id string) {
	m.file = &id
}
...
func (m *FieldTypeMutation) FileID() (id string, exists bool) {
	if m.file != nil {
		return *m.file, true
	}
	return
...
func (m *FieldTypeMutation) FileIDs() (ids []string) {
	if id := m.file; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *FileMutation) SetFileGroupID(id string) {
	m.file_group = &id
}
...
func (m *FileMutation) FileGroupID() (id string, exists bool) {
	if m.file_group != nil {
...
func (m *FileMutation) FileGroupIDs() (ids []string) {
...
func (m *UserMutation) SetBlockedGroupID(id string) {
	m.blocked_group = &id
}
...
func (m *UserMutation) BlockedGroupID() (id string, exists bool) {
...
func (m *UserMutation) BlockedGroupIDs() (ids []string) {
