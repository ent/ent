...
func (m *Mutation) AddBlockedIDs(ids ...string) {
	if m.blocked == nil {
...
func (m *Mutation) RemoveBlockedIDs(ids ...string) {
...
func (m *Mutation) RemovedBlockedIDs() (ids []string) {
...
func (m *Mutation) BlockedIDs() (ids []string) {
...
func (m *Mutation) AddUserIDs(ids ...string) {
	if m.users == nil {
...
func (m *Mutation) RemoveUserIDs(ids ...string) {
...
func (m *Mutation) RemovedUsersIDs() (ids []string) {
...
func (m *Mutation) UsersIDs() (ids []string) {
...
func (m *Mutation) SetInfoID(id string) {
	m.info = &id
}
...
func (m *Mutation) InfoID() (id string, exists bool) {
	if m.info != nil {
		return *m.info, true
	}
	return
...
func (m *Mutation) InfoIDs() (ids []string) {
	if id := m.info; id != nil {
		ids = append(ids, *id)
	}
	return
