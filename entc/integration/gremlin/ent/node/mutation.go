...
func (m *Mutation) SetPrevID(id string) {
	m.prev = &id
}
...
func (m *Mutation) PrevID() (id string, exists bool) {
	if m.prev != nil {
		return *m.prev, true
	}
	return
...
func (m *Mutation) PrevIDs() (ids []string) {
	if id := m.prev; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *Mutation) SetNextID(id string) {
	m.next = &id
}
...
func (m *Mutation) NextID() (id string, exists bool) {
	if m.next != nil {
		return *m.next, true
	}
	return
...
func (m *Mutation) NextIDs() (ids []string) {
	if id := m.next; id != nil {
		ids = append(ids, *id)
	}
	return
