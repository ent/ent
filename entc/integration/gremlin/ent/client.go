...
func (c *APIClient) UpdateOne(m *Api) *APIUpdateOne {
	mutation := newAPIMutation(c.config, OpUpdateOne, withApi(m))
...
func (c *APIClient) DeleteOne(m *Api) *APIDeleteOne {
...
// UpdateOne returns an update builder for the given entity.
func (c *BuilderClient) UpdateOne(m *Builder) *BuilderUpdateOne {
	mutation := newBuilderMutation(c.config, OpUpdateOne, withBuilder(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *BuilderClient) DeleteOne(m *Builder) *BuilderDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *CardClient) UpdateOne(m *Card) *CardUpdateOne {
	mutation := newCardMutation(c.config, OpUpdateOne, withCard(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *CardClient) DeleteOne(m *Card) *CardDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *CardClient) QueryOwner(m *Card) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(user.CardLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *CardClient) QuerySpec(m *Card) *SpecQuery {
	query := (&SpecClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(spec.CardLabel).OutV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *CommentClient) UpdateOne(m *Comment) *CommentUpdateOne {
	mutation := newCommentMutation(c.config, OpUpdateOne, withComment(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *CommentClient) DeleteOne(m *Comment) *CommentDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *ExValueScanClient) UpdateOne(m *ExValueScan) *ExValueScanUpdateOne {
	mutation := newExValueScanMutation(c.config, OpUpdateOne, withExValueScan(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *ExValueScanClient) DeleteOne(m *ExValueScan) *ExValueScanDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *FieldTypeClient) UpdateOne(m *FieldType) *FieldTypeUpdateOne {
	mutation := newFieldTypeMutation(c.config, OpUpdateOne, withFieldType(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *FieldTypeClient) DeleteOne(m *FieldType) *FieldTypeDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *FileClient) QueryOwner(m *File) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(user.FilesLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *FileClient) QueryType(m *File) *FileTypeQuery {
	query := (&FileTypeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(filetype.FilesLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *FileClient) QueryField(m *File) *FieldTypeQuery {
	query := (&FieldTypeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(file.FieldLabel).InV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *FileTypeClient) UpdateOne(m *FileType) *FileTypeUpdateOne {
	mutation := newFileTypeMutation(c.config, OpUpdateOne, withFileType(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *FileTypeClient) DeleteOne(m *FileType) *FileTypeDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *FileTypeClient) QueryFiles(m *FileType) *FileQuery {
	query := (&FileClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(filetype.FilesLabel).InV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *GoodsClient) UpdateOne(m *Goods) *GoodsUpdateOne {
	mutation := newGoodsMutation(c.config, OpUpdateOne, withGoods(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *GoodsClient) DeleteOne(m *Goods) *GoodsDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *GroupClient) QueryFiles(m *Group) *FileQuery {
	query := (&FileClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(group.FilesLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *GroupClient) QueryBlocked(m *Group) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(group.BlockedLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *GroupClient) QueryUsers(m *Group) *UserQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(m.ID).InE(user.GroupsLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *GroupClient) QueryInfo(m *Group) *GroupInfoQuery {
	query := (&GroupInfoClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(group.InfoLabel).InV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *GroupInfoClient) UpdateOne(m *GroupInfo) *GroupInfoUpdateOne {
	mutation := newGroupInfoMutation(c.config, OpUpdateOne, withGroupInfo(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *GroupInfoClient) DeleteOne(m *GroupInfo) *GroupInfoDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *GroupInfoClient) QueryGroups(m *GroupInfo) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(group.InfoLabel).OutV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *ItemClient) UpdateOne(m *Item) *ItemUpdateOne {
	mutation := newItemMutation(c.config, OpUpdateOne, withItem(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *ItemClient) DeleteOne(m *Item) *ItemDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *LicenseClient) UpdateOne(m *License) *LicenseUpdateOne {
	mutation := newLicenseMutation(c.config, OpUpdateOne, withLicense(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *LicenseClient) DeleteOne(m *License) *LicenseDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *NodeClient) QueryPrev(m *Node) *NodeQuery {
	query := (&NodeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(node.NextLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *NodeClient) QueryNext(m *Node) *NodeQuery {
	query := (&NodeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(node.NextLabel).InV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *PCClient) UpdateOne(m *PC) *PCUpdateOne {
	mutation := newPCMutation(c.config, OpUpdateOne, withPC(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *PCClient) DeleteOne(m *PC) *PCDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *PetClient) QueryTeam(m *Pet) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(user.TeamLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *PetClient) QueryOwner(m *Pet) *UserQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(m.ID).InE(user.PetsLabel).OutV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *SpecClient) UpdateOne(m *Spec) *SpecUpdateOne {
	mutation := newSpecMutation(c.config, OpUpdateOne, withSpec(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *SpecClient) DeleteOne(m *Spec) *SpecDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *SpecClient) QueryCard(m *Spec) *CardQuery {
	query := (&CardClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(spec.CardLabel).InV()
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *TaskClient) UpdateOne(m *Task) *TaskUpdateOne {
	mutation := newTaskMutation(c.config, OpUpdateOne, withTask(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TaskClient) DeleteOne(m *Task) *TaskDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *UserClient) QueryCard(m *User) *CardQuery {
	query := (&CardClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(user.CardLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryPets(m *User) *PetQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(m.ID).OutE(user.PetsLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryFiles(m *User) *FileQuery {
	query := (&FileClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(user.FilesLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryGroups(m *User) *GroupQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(m.ID).OutE(user.GroupsLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryFriends(m *User) *UserQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(m.ID).Both(user.FriendsLabel)
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryFollowers(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(user.FollowingLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryFollowing(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(user.FollowingLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryTeam(m *User) *PetQuery {
	query := (&PetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(user.TeamLabel).InV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QuerySpouse(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).Both(user.SpouseLabel)
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryChildren(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).InE(user.ParentLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QueryParent(m *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {

		fromV = g.V(m.ID).OutE(user.ParentLabel).InV()
		return fromV, nil
	}
	return query
}
