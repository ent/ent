...
// UpdateOneID returns an update builder for the given id.
func (c *SocialProfileClient) UpdateOneID(id string) *SocialProfileUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SocialProfileClient) DeleteOneID(id string) *SocialProfileDeleteOne {
...
func (c *SocialProfileClient) Get(ctx context.Context, id string) (*SocialProfile, error) {
	return c.Query().Where(socialprofile.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SocialProfileClient) GetX(ctx context.Context, id string) *SocialProfile {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *SocialProfileClient) QueryUser(sp *SocialProfile) *UserQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(sp.ID).InE(user.SocialProfilesLabel).OutV()
		return fromV, nil
	}
	return query
}
...
func (c *UserClient) QuerySocialProfiles(u *User) *SocialProfileQuery {
	...
	query.path = func(context.Context) (fromV *dsl.Traversal, _ error) {
		...
		fromV = g.V(u.ID).OutE(user.SocialProfilesLabel).InV()
		return fromV, nil
	}
	return query
}
