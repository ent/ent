...
func (q *UserQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (q *UserQuery) FirstIDX(ctx context.Context) uint64 {
...
func (q *UserQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (q *UserQuery) OnlyIDX(ctx context.Context) uint64 {
	id, err := q.OnlyID(ctx)
	if err != nil {
		panic(err)
	}
...
func (q *UserQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (q *UserQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := q.IDs(ctx)
	if err != nil {
		panic(err)
	}
