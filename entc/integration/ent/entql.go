...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[4] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			document.FieldAttachment: {Type: field.TypeBytes, Column: document.FieldAttachment},
			document.FieldPayload:    {Type: field.TypeBytes, Column: document.FieldPayload},
		},
	}
...
// WhereAttachment applies the entql []byte predicate on the attachment field.
func (f *DocumentFilter) WhereAttachment(p entql.BytesP) {
