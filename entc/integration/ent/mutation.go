...
func withSocialProfileID(id int) socialprofileOption {
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SocialProfileMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SocialProfileMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *SocialProfileMutation) SetUserID(id int) {
	m.user = &id
}
...
func (m *SocialProfileMutation) UserID() (id int, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
func (m *SocialProfileMutation) UserIDs() (ids []int) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SocialProfileMutation) WhereP(ps ...func(*sql.Selector)) {
...
type UserMutation struct {
	...
	parent                 *int
	clearedparent          bool
	social_profiles        map[int]struct{}
	removedsocial_profiles map[int]struct{}
...
func (m *UserMutation) AddSocialProfileIDs(ids ...int) {
	if m.social_profiles == nil {
		m.social_profiles = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveSocialProfileIDs(ids ...int) {
	if m.removedsocial_profiles == nil {
		m.removedsocial_profiles = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedSocialProfilesIDs() (ids []int) {
...
func (m *UserMutation) SocialProfilesIDs() (ids []int) {
