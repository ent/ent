...
func (m *Mutation) SetArchive(r io.Reader) {
	m.archive = r
}

// Archive returns the value of the "archive" field in the mutation.
func (m *Mutation) Archive() (r io.Reader, exists bool) {
	v := m.archive
	if v == nil {
		return
	}
...
func (m *Mutation) ClearArchive() {
	m.archive = nil
	m.clearedFields[FieldArchive] = struct{}{}
}

// ArchiveCleared returns if the "archive" field was cleared in this mutation.
func (m *Mutation) ArchiveCleared() bool {
	_, ok := m.clearedFields[FieldArchive]
	return ok
}

// ResetArchive resets all changes to the "archive" field.
func (m *Mutation) ResetArchive() {
	m.archive = nil
	delete(m.clearedFields, FieldArchive)
}
...
func (m *Mutation) ClearedFields() []string {
	...
	if m.FieldCleared(FieldArchive) {
		fields = append(fields, FieldArchive)
	}
	return fields
}
