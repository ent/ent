...
func (q *PetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Pet, error) {
	...
	if q.withTeam != nil || q.withOwner != nil {
		withFKs = true
	}
	if withFKs {
...
func (q *PetQuery) loadTeam(ctx context.Context, query *UserQuery, nodes []*Pet, init func(*Pet), assign func(*Pet, *User)) error {
...
func (q *PetQuery) Modify(modifiers ...func(s *sql.Selector)) *PetSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (q *PetSelect) Modify(modifiers ...func(s *sql.Selector)) *PetSelect {
	q.modifiers = append(q.modifiers, modifiers...)
	return q
}
