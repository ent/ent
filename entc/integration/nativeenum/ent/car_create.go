...
func (cc *CarCreate) SetTransmission(s string) *CarCreate {
	cc.mutation.SetTransmission(s)
	return cc
}
...
func (cc *CarCreate) check() error {
	if _, ok := cc.mutation.Transmission(); !ok {
		return &ValidationError{Name: "transmission", err: errors.New("ent: missing required field \"transmission\"")}
	}
	return nil
}
...
func (cc *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.Transmission(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: car.FieldTransmission,
		})
		_node.Transmission = value
	}
	return _node, _spec
}
