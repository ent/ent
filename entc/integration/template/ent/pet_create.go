...
func (m *PetCreate) SetAge(v int) *PetCreate {
	m.mutation.SetAge(v)
	return m
}

// SetLicensedAt sets the "licensed_at" field.
func (m *PetCreate) SetLicensedAt(v time.Time) *PetCreate {
	m.mutation.SetLicensedAt(v)
	return m
}

// SetNillableLicensedAt sets the "licensed_at" field if the given value is not nil.
func (m *PetCreate) SetNillableLicensedAt(v *time.Time) *PetCreate {
	if v != nil {
		m.SetLicensedAt(*v)
	}
	return m
...
func (c *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	...
	if value, ok := c.mutation.LicensedAt(); ok {
