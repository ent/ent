...
func (c *AccountClient) UpdateOne(m *Account) *AccountUpdateOne {
	mutation := newAccountMutation(c.config, OpUpdateOne, withAccount(m))
...
func (c *AccountClient) DeleteOne(m *Account) *AccountDeleteOne {
...
func (c *AccountClient) QueryToken(m *Account) *TokenQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *BlobClient) UpdateOne(m *Blob) *BlobUpdateOne {
	mutation := newBlobMutation(c.config, OpUpdateOne, withBlob(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *BlobClient) DeleteOne(m *Blob) *BlobDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *BlobClient) QueryParent(m *Blob) *BlobQuery {
...
func (c *BlobClient) QueryLinks(m *Blob) *BlobQuery {
	query := (&BlobClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *BlobClient) QueryBlobLinks(m *Blob) *BlobLinkQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *BlobLinkClient) UpdateOne(m *BlobLink) *BlobLinkUpdateOne {
	mutation := newBlobLinkMutation(c.config, OpUpdateOne)
	mutation.blob = &m.BlobID
	mutation.link = &m.LinkID
...
func (c *BlobLinkClient) QueryBlob(m *BlobLink) *BlobQuery {
	return c.Query().
		Where(bloblink.BlobID(m.BlobID), bloblink.LinkID(m.LinkID)).
		QueryBlob()
}

// QueryLink queries the link edge of a BlobLink.
func (c *BlobLinkClient) QueryLink(m *BlobLink) *BlobQuery {
	return c.Query().
		Where(bloblink.BlobID(m.BlobID), bloblink.LinkID(m.LinkID)).
		QueryLink()
}
...
func (c *CarClient) QueryOwner(m *Car) *PetQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *DeviceClient) UpdateOne(m *Device) *DeviceUpdateOne {
	mutation := newDeviceMutation(c.config, OpUpdateOne, withDevice(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *DeviceClient) DeleteOne(m *Device) *DeviceDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *DeviceClient) QueryActiveSession(m *Device) *SessionQuery {
...
func (c *DeviceClient) QuerySessions(m *Device) *SessionQuery {
	query := (&SessionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *DocClient) UpdateOne(m *Doc) *DocUpdateOne {
	mutation := newDocMutation(c.config, OpUpdateOne, withDoc(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *DocClient) DeleteOne(m *Doc) *DocDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *DocClient) QueryParent(m *Doc) *DocQuery {
...
func (c *DocClient) QueryChildren(m *Doc) *DocQuery {
	query := (&DocClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *DocClient) QueryRelated(m *Doc) *DocQuery {
	query := (&DocClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *IntSIDClient) UpdateOne(m *IntSID) *IntSIDUpdateOne {
	mutation := newIntSIDMutation(c.config, OpUpdateOne, withIntSID(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *IntSIDClient) DeleteOne(m *IntSID) *IntSIDDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *IntSIDClient) QueryParent(m *IntSID) *IntSIDQuery {
...
func (c *IntSIDClient) QueryChildren(m *IntSID) *IntSIDQuery {
	query := (&IntSIDClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *LinkClient) UpdateOne(m *Link) *LinkUpdateOne {
	mutation := newLinkMutation(c.config, OpUpdateOne, withLink(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *LinkClient) DeleteOne(m *Link) *LinkDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *MixinIDClient) UpdateOne(m *MixinID) *MixinIDUpdateOne {
	mutation := newMixinIDMutation(c.config, OpUpdateOne, withMixinID(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *MixinIDClient) DeleteOne(m *MixinID) *MixinIDDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *NoteClient) UpdateOne(m *Note) *NoteUpdateOne {
	mutation := newNoteMutation(c.config, OpUpdateOne, withNote(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *NoteClient) DeleteOne(m *Note) *NoteDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *NoteClient) QueryParent(m *Note) *NoteQuery {
...
func (c *NoteClient) QueryChildren(m *Note) *NoteQuery {
	query := (&NoteClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *OtherClient) UpdateOne(m *Other) *OtherUpdateOne {
	mutation := newOtherMutation(c.config, OpUpdateOne, withOther(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *OtherClient) DeleteOne(m *Other) *OtherDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *PetClient) QueryCars(m *Pet) *CarQuery {
...
func (c *PetClient) QueryBestFriend(m *Pet) *PetQuery {
	query := (&PetClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *RevisionClient) UpdateOne(m *Revision) *RevisionUpdateOne {
	mutation := newRevisionMutation(c.config, OpUpdateOne, withRevision(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *RevisionClient) DeleteOne(m *Revision) *RevisionDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
// UpdateOne returns an update builder for the given entity.
func (c *SessionClient) UpdateOne(m *Session) *SessionUpdateOne {
	mutation := newSessionMutation(c.config, OpUpdateOne, withSession(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *SessionClient) DeleteOne(m *Session) *SessionDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *SessionClient) QueryDevice(m *Session) *DeviceQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *TokenClient) UpdateOne(m *Token) *TokenUpdateOne {
	mutation := newTokenMutation(c.config, OpUpdateOne, withToken(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TokenClient) DeleteOne(m *Token) *TokenDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *TokenClient) QueryAccount(m *Token) *AccountQuery {
