...
func (c *BlobClient) Use(hooks ...ent.Hook) {
...
func (c *BlobClient) Create() *BlobCreate {
	hooks := c.hooks
	mutation := newBlobMutation(OpCreate)
...
func (c *BlobClient) Update() *BlobUpdate {
	hooks := c.hooks
	mutation := newBlobMutation(OpUpdate)
...
func (c *BlobClient) UpdateOneID(id uuid.UUID) *BlobUpdateOne {
	hooks := c.hooks
	mutation := newBlobMutation(OpUpdateOne)
	mutation.id = &id
...
func (c *BlobClient) Delete() *BlobDelete {
	hooks := c.hooks
	mutation := newBlobMutation(OpDelete)
