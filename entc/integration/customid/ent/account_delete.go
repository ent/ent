...
func (d *AccountDelete) Where(ps ...predicate.Account) *AccountDelete {
	d.mutation.Where(ps...)
	return d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (d *AccountDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, d.sqlExec, d.mutation, d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (d *AccountDelete) ExecX(ctx context.Context) int {
	n, err := d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (d *AccountDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the AccountDelete builder.
func (d *AccountDeleteOne) Where(ps ...predicate.Account) *AccountDeleteOne {
	d.d.mutation.Where(ps...)
	return d
}

// Exec executes the deletion query.
func (d *AccountDeleteOne) Exec(ctx context.Context) error {
	n, err := d.d.Exec(ctx)
	switch {
	case err != nil:
		return err
...
// ExecX is like Exec, but panics if an error occurs.
func (d *AccountDeleteOne) ExecX(ctx context.Context) {
