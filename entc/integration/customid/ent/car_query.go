...
func (q *CarQuery) QueryOwner() *PetQuery {
...
func (q *CarQuery) WithOwner(opts ...func(*PetQuery)) *CarQuery {
	query := (&PetClient{config: q.config}).Query()
...
func (q *CarQuery) loadOwner(ctx context.Context, query *PetQuery, nodes []*Car, init func(*Car), assign func(*Car, *Pet)) error {
