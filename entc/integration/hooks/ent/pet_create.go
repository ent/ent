...
func (m *PetCreate) SetDeleteTime(v time.Time) *PetCreate {
	m.mutation.SetDeleteTime(v)
	return m
}

// SetNillableDeleteTime sets the "delete_time" field if the given value is not nil.
func (m *PetCreate) SetNillableDeleteTime(v *time.Time) *PetCreate {
	if v != nil {
		m.SetDeleteTime(*v)
	}
	return m
...
func (m *PetCreate) SetNillableName(v *string) *PetCreate {
	if v != nil {
		m.SetName(*v)
	}
	return m
...
func (c *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	...
	if value, ok := c.mutation.DeleteTime(); ok {
