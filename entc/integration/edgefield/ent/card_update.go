...
func (m *CardUpdate) ClearNumber() *CardUpdate {
...
func (m *CardUpdate) ClearOwnerID() *CardUpdate {
...
// ClearNumber clears the value of the "number" field.
func (m *CardUpdateOne) ClearNumber() *CardUpdateOne {
	m.mutation.ClearNumber()
	return m
}
...
// ClearOwnerID clears the value of the "owner_id" field.
func (m *CardUpdateOne) ClearOwnerID() *CardUpdateOne {
	m.mutation.ClearOwnerID()
	return m
}
