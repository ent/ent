...
func (m *Car) QueryRentals() *RentalQuery {
	return NewCarClient(m.config).QueryRentals(m)
}
...
func (m *Car) NamedRentals(name string) ([]*Rental, error) {
...
func (m *Car) appendNamedRentals(name string, edges ...*Rental) {
	if m.Edges.namedRentals == nil {
