...
func (c *CarClient) QueryRentals(m *Car) *RentalQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *InfoClient) UpdateOne(m *Info) *InfoUpdateOne {
	mutation := newInfoMutation(c.config, OpUpdateOne, withInfo(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *InfoClient) DeleteOne(m *Info) *InfoDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *InfoClient) QueryUser(m *Info) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *PostClient) UpdateOne(m *Post) *PostUpdateOne {
	mutation := newPostMutation(c.config, OpUpdateOne, withPost(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *PostClient) DeleteOne(m *Post) *PostDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *PostClient) QueryAuthor(m *Post) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *RentalClient) UpdateOne(m *Rental) *RentalUpdateOne {
	mutation := newRentalMutation(c.config, OpUpdateOne, withRental(m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *RentalClient) DeleteOne(m *Rental) *RentalDeleteOne {
	return c.DeleteOneID(m.ID)
}
...
func (c *RentalClient) QueryUser(m *Rental) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *RentalClient) QueryCar(m *Rental) *CarQuery {
...
func (c *UserClient) QueryMetadata(m *User) *MetadataQuery {
	query := (&MetadataClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryInfo(m *User) *InfoQuery {
...
func (c *UserClient) QueryRentals(m *User) *RentalQuery {
	query := (&RentalClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
